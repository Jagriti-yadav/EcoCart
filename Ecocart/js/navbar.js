        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link ${activePage === 'team' ? 'active fw-semibold' : ''}" ${activePage === 'team' ? 'aria-current="page"' : ''} href="team.html">
                            <i class="bi bi-people me-1"></i>Team
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activePage === 'donation' ? 'active fw-semibold' : ''}" ${activePage === 'donation' ? 'aria-current="page"' : ''} href="donation.html">
...
function getActivePage() {
    ...
    if (page.includes('team')) return 'team';
    if (page.includes('donation')) return 'donation';
